...
The development is forced by symmetries: the reflection
$s\mapsto 1-s$ across the critical line, the conjugation
$s\mapsto\bar s$, and the pairing of the odd and even parts of the
Dirichlet series. Each layer below is the least statement that the
previous one leaves open --- the reflection forces the orbit structure,
$|\Xchi|=1$ on the line forces $u^2=\Xchi$, and the divergence of the
unpaired series forces the pairing that closes the $(0,1)$-segment.
...
a pure constant of the phase structure --- and, as Layer~9 will show,
the same phase structure governs the multiplier $\Xchi$ on the critical
line.
