...
pairing (iso~41). The development is a chain of 235 verified Lean~4
...
\S\ref{sec:flip}) is exactly the phase locking of the framework
...
A \emph{flip} is a sign change of $\Re\zt$ across the critical line; the
\emph{flip count} is the number of flips recorded by the lifted phases of
Layer~10. The \emph{winding number} of $\Xchi$ along a path is the total
...
finite-reaching-infinite (\S\ref{sec:L11}, \S\ref{sec:growth}).
...
existing fast paths (\S\ref{sec:flip}, \S\ref{sec:methodology},
\S\ref{sec:L10}).
...
must be assembled, not cited (\S\ref{sec:L8}, \S\ref{sec:bottom}).
