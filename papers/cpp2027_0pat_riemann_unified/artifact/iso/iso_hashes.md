...
| 2026-08-22 | PhaseAlign_iso.lean | 9daa746d0833e97e | 相位对齐位置刻画 (iso 44): phaseAlign_iff_zeta_reflect (对齐 ⟺ ζ(1−s)=conj(ζ(s)), 函数方程因子 χ=ζ(s)/ζ(1−s)) / phaseAlign_imp_unit_modulus (⟹ ‖χ‖=1) / critical_line_iff_reflect_fixed (临界线 = 复合反射不动点 s=1−conj s) / phaseAlign_of_critical_line (临界线 ⟹ 对齐, riemannZeta_conj) / zeta_zero_phaseAlign (ζ 零点 = 对齐平凡解, 任意位置 — 钉死零点不被对齐方程排除) — 5 定理 0-sorry, 只 import Mathlib; 开问题 (数值支持): 非平凡对齐解 ⊆ 临界线 |
