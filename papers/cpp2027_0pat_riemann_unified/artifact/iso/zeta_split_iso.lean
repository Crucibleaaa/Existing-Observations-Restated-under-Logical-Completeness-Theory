...
/-!
# ζ 的实部/虚部拆分 (假实轴部分 + y 轴泄漏部分)

共轭三片 (conj(ζ(s)) = ζ(conj s)) 的 Re/Im 投影:
  实部 (假实轴投影): 偶对称 Re ζ(s) = Re ζ(conj s)
  虚部 (y 轴泄漏): 奇反对称 Im ζ(s) = -Im ζ(conj s)
  临界线特例: Re ζ(1/2+it) 偶, Im ζ(1/2+it) 奇
  零点 = 两部分的公共零点: ζ(z) = 0 ⟺ Re = 0 ∧ Im = 0
-/
