...
All one hundred and thirty declarations (one hundred and fifteen theorems and
fifteen lemmas) are machine-checked in Lean 4 + mathlib from known
...
v4.32.2): one hundred and thirty declarations (one hundred and fifteen theorems and
fifteen lemmas), zero errors, zero \texttt{sorry}; and
\texttt{observation.md}, a record of thirty numerical observations
